...
export const TRAINING_DECK_DEFINITIONS: TrainingDeckDefinition[] = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        locationType: "HOME",
        difficulty: "EASY",
        categoryPoints: { WELLNESS: 2, CHARACTER: 1 },
    ...
    cards: [
      {
        ...
        locationType: "HOME",
        difficulty: "EASY",
        categoryPoints: { RESPONSIBILITY: 2, WELLNESS: 1 },
        proofType: "CHECKLIST",
      ...
      },
      {
        ...
        locationType: "HOME",
        difficulty: "MEDIUM",
        categoryPoints: { RESPONSIBILITY: 2, WELLNESS: 1, CHARACTER: 1 },
        proofType: "SHORT_REFLECTION",
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        locationType: "OUTDOOR",
        difficulty: "MEDIUM",
        categoryPoints: { WELLNESS: 2, CREATIVITY: 2, CHARACTER: 1 },
        proofType: "SHORT_REFLECTION",
      ...
      },
      {
        ...
        locationType: "OUTDOOR",
        difficulty: "EASY",
        categoryPoints: { CREATIVITY: 3, WELLNESS: 1 },
        proofType: "SHORT_REFLECTION",
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        locationType: "OUTDOOR",
        difficulty: "MEDIUM",
        categoryPoints: { COMMUNITY: 2, WELLNESS: 1, CREATIVITY: 1 },
        proofType: "SHORT_REFLECTION",
