...
export function TaskBoardWorkflow({
  ...
  return (
    <div className="space-y-10">
      ...
      <section id="assignment" className="scroll-mt-44 space-y-4">
        <SectionHeader
          title="Created"
          description="Assignment board — unassigned tasks ready to assign to a Cub."
        />
        <Card>
          <h3 className="text-sm font-semibold">Create one-off task</h3>
          <p className="mt-1 text-sm text-zinc-500">
            Add a custom task directly to the assignment board.
          </p>
          <div className="mt-4">
        ...
        {created.length === 0 ? (
          <p className="text-sm text-zinc-500">
            No tasks on the assignment board. Create one above or add from the{" "}
      ...
      <section id="active" className="scroll-mt-44 space-y-4">
        <SectionHeader
          title="Active"
      ...
      <section id="in-review" className="scroll-mt-44 space-y-4">
        <SectionHeader
          title="In review"
      ...
      <section id="completed" className="scroll-mt-44 space-y-4">
        <SectionHeader
          title="Completed"
