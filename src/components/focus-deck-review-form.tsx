...
import {
  ...
  rejectFocusCompletionAction,
  sendBackFocusCompletionAction,
} from "@/lib/actions/focus-deck";
import { cubErrorText, cubSuccessText } from "@/lib/cub-theme";
import { cn } from "@/lib/utils";
import { useActionState } from "react";

type FocusDeckReviewFormProps = {
  completionId: string;
};

export function FocusDeckReviewForm({ completionId }: FocusDeckReviewFormProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        <Button type="submit" variant="constructive" fullWidth size="lg" disabled={approvePending}>
      ...
      >
        ...
        <Button type="submit" variant="warning" fullWidth size="lg" disabled={sendBackPending}>
      ...
      >
        ...
        <Button type="submit" variant="danger" fullWidth size="lg" disabled={rejectPending}>
