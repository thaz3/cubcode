...
type ChallengeRewardFieldsProps = {
  initialValues?: {
...
export function ChallengeRewardFields({
  initialValues,
  ...
  return (
    <div className="space-y-4 rounded-lg border border-zinc-200 bg-zinc-50/50 p-4 dark:border-zinc-700 dark:bg-zinc-900/50">
      <div>
        <h4 className="text-sm font-medium">Rewards per approved check-in</h4>
        <p className="mt-1 text-sm text-zinc-500">
          Your Cub earns these when you approve each routine interval.
        </p>
      </div>
